  ...
  <div class="p-6">
    ...
    <Tabs default-value="rsi" class="w-full space-y-4">
      <TabsList class="flex border-b">
        <TabsTrigger value="rsi" class="py-2 px-3 text-sm font-medium hover:text-blue-600">
          RSI
        </TabsTrigger>
        <TabsTrigger value="macd" class="py-2 px-3 text-sm font-medium hover:text-blue-600">
          MACD
        </TabsTrigger>
      </TabsList>
      ...
      <TabsContent value="macd">
        ...
        <div class="bg-white rounded shadow p-4 mt-2">
          <LineChart
            :data="macdChartData"
            index="date"
