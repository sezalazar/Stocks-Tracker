<template>
    <div class="w-full mx-auto p-4">
        ...
        <form @submit.prevent="submitForm" class="mb-8">
            <div class="mb-4">
                <label for="market_data" class="block text-sm font-medium text-gray-700">Paste Options Data Block here</label>
                <textarea
                    id="market_data"
        ...
        <div v-if="page.props.underlying" class="mt-8">
            ...
            <div class="mb-6 p-4 border rounded">
                ...
                <p>
                    ...
                    {{ page.props.underlying.symbol }}
                </p>
                <p>
                    <strong>Compra:</strong>
                    {{ page.props.underlying.buy_price }}
                </p>
                <p>
                    <strong>Venta:</strong>
                    {{ page.props.underlying.sell_price }}
                </p>
                <p>
                    <strong>Último Precio:</strong>
                    {{ page.props.underlying.last_price }}
                </p>
            </div>
                            ...
                            <template v-for="(row, rowIndex) in group.rows" :key="row.strike">
                                <tr>
                                    ...
                                    <td
                                        ...
                                        :class="{
                                            'text-green-600': row.call?.variation_percent > 0,
                                            'text-red-600': row.call?.variation_percent < 0,
                                        }"
                                    >
                                    ...
                                    <td
                                        class="border p-1 text-center"
                                        :class="{
                                            'text-green-600': row.put?.variation_percent > 0,
                                            'text-red-600': row.put?.variation_percent < 0,
                                        }"
                                    >
