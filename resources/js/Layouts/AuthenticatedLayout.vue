        ...
        <nav class="border-b border-gray-700 bg-gray-800 text-gray-100">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                        <button type="button" class="text-gray-400 hover:text-gray-200 focus:outline-hidden">
                    ...
                    <div class="-mr-2 flex items-center sm:hidden">
                        <button
                            ...
                            class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-gray-200 focus:outline-hidden"
                        >
            ...
            >
                <div class="space-y-1 border-b border-gray-700 pt-2 pb-3">
                    <Link :href="route('dashboard')" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-gray-100">
                        Dashboard
                    </Link>
                </div>
                ...
                <div class="border-t border-gray-700 pt-4 pb-1">
                    ...
                    <div class="mt-3 space-y-1 px-4">
                        <Link :href="route('profile.edit')" class="block py-1 text-sm text-gray-300 hover:text-gray-100 hover:underline">
                            Profile
                        </Link>
                        <form :action="route('logout')" method="post" class="block">
                            @csrf
                            <button type="submit" class="py-1 text-sm text-gray-300 hover:text-gray-100 hover:underline">Log Out</button>
                        </form>
                    </div>
                </div>
            </div>
