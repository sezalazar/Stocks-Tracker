...
function rowLinkStyle() {
  return 'hover:bg-[hsl(var(--row-hover-background))] hover:text-[hsl(var(--brand-gray))] cursor-pointer transition-colors duration-150 ease-in-out'
}
</script>
...
<template>
  <div>
    ...
    <div class="rounded-lg border bg-[hsl(var(--card))]">
      <Table>
        <TableHeader>
          <TableRow v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id" class="border-b border-[hsl(var(--border))] hover:bg-transparent">
